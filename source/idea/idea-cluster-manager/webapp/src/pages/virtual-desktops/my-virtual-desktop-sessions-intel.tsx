...
class MyVirtualDesktopSessionsIntel extends Component<MyVirtualDesktopSessionsProps, MyVirtualDesktopSessionsState> {
...
export default withRouter(MyVirtualDesktopSessionsIntel);
